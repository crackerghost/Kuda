    ...
    <div className="bg-blue-900 text-white w-60 p-4 flex flex-col rounded-2xl m-4">
      <div className="mb-8">
        <img
          ...
          alt="User"
        />
        <h2 className="text-center mt-4 text-2xl">Indica Watson</h2>
        <h2 className='text-center mt-2 text-gray-400 mb-4'>User Profile</h2>
      </div>
      <ul>
        ...
        <li className="mb-5"><a href="#" className="flex items-center p-2 rounded hover:border hover:border-black hover:bg-black transition duration-300"><span class="material-symbols-outlined mr-2">sms</span>  Inbox</a></li>

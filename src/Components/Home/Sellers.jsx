...
function Sellers() {
  return (
    <div className="containers Seller">
      <div className="w-[40%]">
        <h1 className="text-mBold">For Sellers</h1>
      </div>
      
     <div className="inner-container sellers">
      
            
           
     <div className="flex justify-center items-center">
            <img src="/assets/Landingpage/sellersMain.svg" alt="" />
      </div>
            ...
            <p className="text-mSmall">
              ...
              and have the choice of all types of metal scrap and recycled
              metals. We don't charge any subscription fees.
            </p>
            <div className="flex items-center">
              <img
                className="w-[48px] h-[48px]"
            ...
            <p className="text-mSmall">
              Receiving goods is easy. METYCLE takes care of the whole journey
              for you and you stay informed about every step. Your logistics
              worries will be gone with our live container tracking.
            </p>
          </div>

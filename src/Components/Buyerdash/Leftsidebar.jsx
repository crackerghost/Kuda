    ...
    return (
      <div className="bg-blue-900 text-white w-60 p-4 flex flex-col rounded-2xl m-4">
        ...
        <ul>
          ...
          <li className="mb-5"><a href="#" className="flex items-center p-2 rounded hover:border hover:border-black hover:bg-black transition duration-300"><span className="material-symbols-outlined mr-2">settings</span>Add Items</a></li>
        </ul>
      </div>
    );
  };
